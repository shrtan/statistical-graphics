...
This tutorial will demonstrate how to represent odds ratio of mortality rates of four different categories - Sex, Socioeconomic condition, Period of the pandemic and Preexisting conditions. Each of the categories will have one reference group with respect to which the odds ratio is calculated. 

We have a data frame that have columns factors, groups/categoies to which the factors belong to, odds ratio, lower limits of confidence interval and upper limits of confidence intervals. 
...
or.df <- data.frame(
  ...
  ll = c(NA, 1.09, NA, 1.56, NA, 0.85, 0.77, 4.63, NA, 0.97, 1.04, 0.92, 2.04, 1.57, 1.29),
  ul = c(NA, 1.22, NA, 1.98, NA, 0.95, 0.91, 7.83, NA, 1.15, 1.23, 1.20, 2.67, 2.74, 1.61))
